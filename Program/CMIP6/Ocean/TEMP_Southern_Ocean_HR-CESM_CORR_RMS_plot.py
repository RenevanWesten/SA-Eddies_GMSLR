...
TEMP_data = netcdf.Dataset(directory_cesm+'Ocean/TEMP_Southern_Ocean_HR-CESM_to_CMIP6.nc', 'r')
...
TEMP_data = netcdf.Dataset(directory_cesm+'Ocean/TEMP_Southern_Ocean_HR-CESM_to_LR-CESM.nc', 'r')

#Writing data to correct variable	
corr_LR	= TEMP_data.variables['CORR'][0]
rms_LR	= TEMP_data.variables['RMS'][0] 		
...
#HR-CESM
graph_HR_CESM	= ax.scatter(1, 0, marker = 'o', color = 'red', s = 75, label = 'HR-CESM (10 km)')
graph_LR_CESM	= ax.scatter(corr_LR, rms_LR, marker = 'o', color = 'blue', s = 75, label = 'LR-CESM (100 km)')
