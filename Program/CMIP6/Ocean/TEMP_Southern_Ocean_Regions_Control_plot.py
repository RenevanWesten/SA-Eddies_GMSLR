#Program plots the temperature (Control simulations) of the five southern ocean regions
...
year_start_control	= 0
year_end_control	= 100
...
for model_i in range(len(models)):
	...
	temp_1_all[model_i]	= temp_1_control
	temp_2_all[model_i]	= temp_2_control
	temp_3_all[model_i]	= temp_3_control
	temp_4_all[model_i]	= temp_4_control
	temp_5_all[model_i]	= temp_5_control
...
time_year_cesm, temp_1_control, temp_2_control, temp_3_control, temp_4_control, temp_5_control = ReadinData(directory_cesm_control+'Ocean/TEMP_Southern_Ocean_Regions.nc')

time_year_cesm_low, temp_1_control_low, temp_2_control_low, temp_3_control_low, temp_4_control_low, temp_5_control_low = ReadinData(directory_cesm_low_control+'Ocean/TEMP_Southern_Ocean_Regions.nc')

#-----------------------------------------------------------------------------------------

fig, ax1		= subplots()

graph_CMIP6		= ax1.plot_date(time_year, np.mean(temp_1_all, axis = 0), '-k', linewidth = 2.0, label = 'CMIP6 Control')
...
graph_HR_CESM		= ax1.plot_date(time_year, temp_1_control, '-r', linewidth = 2.0, label = 'HR-CESM Control')
graph_LR_CESM		= ax1.plot_date(time_year, temp_1_control_low, '-b', linewidth = 2.0, label = 'LR-CESM Control')	
...
ax2 = fig.add_axes([0.6, 0.67, 0.2, 0.2])
...
graph_CMIP6		= ax1.plot_date(time_year, np.mean(temp_2_all, axis = 0), '-k', linewidth = 2.0, label = 'CMIP6 Control')
...
graph_HR_CESM		= ax1.plot_date(time_year, temp_2_control, '-r', linewidth = 2.0, label = 'HR-CESM Control')
graph_LR_CESM		= ax1.plot_date(time_year, temp_2_control_low, '-b', linewidth = 2.0, label = 'LR-CESM Control')
...
graph_CMIP6		= ax1.plot_date(time_year, np.mean(temp_3_all, axis = 0), '-k', linewidth = 2.0, label = 'CMIP6 Control')
...
graph_HR_CESM		= ax1.plot_date(time_year, temp_3_control, '-r', linewidth = 2.0, label = 'HR-CESM Control')
graph_LR_CESM		= ax1.plot_date(time_year, temp_3_control_low, '-b', linewidth = 2.0, label = 'LR-CESM Control')	
...
ax2 = fig.add_axes([0.6, 0.12, 0.2, 0.2])
...
graph_CMIP6		= ax1.plot_date(time_year, np.mean(temp_4_all, axis = 0), '-k', linewidth = 2.0, label = 'CMIP6 Control')
...
graph_HR_CESM		= ax1.plot_date(time_year, temp_4_control, '-r', linewidth = 2.0, label = 'HR-CESM Control')
graph_LR_CESM		= ax1.plot_date(time_year, temp_4_control_low, '-b', linewidth = 2.0, label = 'LR-CESM Control')	
...
graph_CMIP6		= ax1.plot_date(time_year, np.mean(temp_5_all, axis = 0), '-k', linewidth = 2.0, label = 'CMIP6 Control')
...
graph_HR_CESM		= ax1.plot_date(time_year, temp_5_control, '-r', linewidth = 2.0, label = 'HR-CESM Control')
graph_LR_CESM		= ax1.plot_date(time_year, temp_5_control_low, '-b', linewidth = 2.0, label = 'LR-CESM Control')
