...
ax.set_title('b) LR-CESM, 2000 - 2029')

x, y		= np.meshgrid(lon_2, lat_2)
x, y		= m(x, y)
#wind_climate	= gaussian_filter(wind_1, sigma = 20)
wind_climate	= ma.masked_array(wind_1, mask = wind_1.mask)
...
ax.set_title('d) LR-CESM, 2071 - 2100 minus 2000 - 2029')
...
wind_climate	= ma.masked_array(wind_2, mask = wind_1.mask)
