...
TEMP_data = netcdf.Dataset(directory+'../HR-CESM_Control/Ocean/TEMP_Southern_Ocean_Regions.nc', 'r')
...
TEMP_data = netcdf.Dataset(directory+'Ocean/Antarctica_basal_melt_SLR.nc', 'w')
